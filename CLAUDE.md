...
- **Claude Code is a CLI that runs in any terminal.** VS Code is the recommended setup and the worked example,
  **never a prerequisite**. Alt text describing the VS Code mockups is exempt — it describes the image.
