...
<PromptCard title="Expert Interview Scorecard" collapse="clamp" prompt={`# Version: 1.0
# Tested on: Claude [model name], [month and year], by [your name]
...
<PromptCard title="Kickoff Agenda" collapse="clamp" prompt={`# Version: 1.0
# Tested on: Claude [model name], [month and year], by [your name]
...
<PromptCard title="Functional Diligence Agenda" collapse="clamp" prompt={`# Version: 1.0
# Tested on: Claude [model name], [month and year], by [your name]
...
<PromptCard title="Project Brain agent instructions" collapse="clamp" prompt={`# Version: 1.0
