...
These templates are filled with live engagement material, so confirm a document is cleared for Claude before you attach it. The checks are in [Your Account & Confidential Data](/foundations/account-and-data#before-you-upload-the-decision).
</Callout>
